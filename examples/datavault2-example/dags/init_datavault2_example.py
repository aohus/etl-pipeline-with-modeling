...
t1 = PythonOperator(
    task_id="init_datavault2_example",
...
def create_table(hql, tablename, upstream, downstream):
    t = HiveOperator(
        task_id="table_{0}".format(tablename),
...
create_table(
    hql="ddl/hub_person.hql", tablename="hub_person", upstream=t4, downstream=hubs_done
)
create_table(
